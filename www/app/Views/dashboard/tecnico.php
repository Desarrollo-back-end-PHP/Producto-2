...
<div class="container">
    ...
    <p style="margin-bottom:30px; color:#666;">Consulta tu agenda de trabajo desde aquí.</p>

    <div style="display:flex; gap:20px; flex-wrap:wrap;">
        <a href="index.php?action=agenda" class="btn" style="padding:20px 30px; font-size:16px;">
            Mi Agenda
        </a>
